...
<div role="document" class="page">
  ...
  <!--.l-header region -->
  <header role="banner" class="l-header row the-top">
    ...
    <?php if ($top_bar): ?>
      ...
      <?php endif; ?>
       <?php if ($site_slogan): ?><div class="site-slogan"><h3><?php print $site_slogan; ?> </h3><?php endif; ?></div>
  ...
  <?php if (!empty($page['triptych_first']) || !empty($page['triptych_middle']) || !empty($page['triptych_last'] ) || !empty($page['triptych_first_2']) || !empty($page['triptych_middle_2']) || !empty($page['triptych_last_2']) || !empty($page['triptych_header'])): ?>
    ...
    <!--.triptych-->
    <div class="row">
    <div class="triptych-first_header-1 large-12 ">
        <?php print render($page['triptych_header_1']); ?>
      </div>
      </div>
    ...
    <!--/.triptych -->
    <div class="row">
    <div class="triptych-first_header large-12 ">
        <?php print render($page['triptych_header']); ?>
      </div>
      </div>
    <section class="l-triptych row">
    
      <div class="triptych-first large-4 columns">
        <?php print render($page['triptych_first_2']); ?>
      </div>
      <div class="triptych-middle large-4 columns">
        <?php print render($page['triptych_middle_2']); ?>
      </div>
      <div class="triptych-last large-4 columns">
        <?php print render($page['triptych_last_2']); ?>
      </div>
    </section>
